...
import triggerConstants from './newLineAccountBudgetMonitorTriggerStepConstants'

const NewLineAccountBudgetMonitorTriggerStepComponent = ({triggerSteps}) => (
  <div>
...
export default NewLineAccountBudgetMonitorTriggerStepComponent
